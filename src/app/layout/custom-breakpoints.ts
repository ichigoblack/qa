...
const BS_BREAKPOINTS = [
  ...
  { alias: 'bs-lg', overlapping: false, mediaQuery: '(min-width: 992px) and (max-width: 1279.98px)', suffix: 'BsLg' },
  { alias: 'bs-xl', overlapping: false, mediaQuery: '(min-width: 1281px)', suffix: 'BsXl' },
  ...
  { alias: 'bs-gt-xl', overlapping: false, mediaQuery: '(min-width: 1281px)', suffix: 'BsGtXl' },
  ...
  { alias: 'bs-lt-xl', overlapping: false, mediaQuery: '(max-width: 1280.98px)', suffix: 'BsLtXl' }
];
